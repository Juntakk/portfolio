...
const data = [
  {
    ...
    image: Image6,
    title: "SeeFlix",
    desc: "API integration, custom hooks, many useEffects ; A web app to get vital real-time information on any and all movies.",
  ...
  },
  {
    ...
    image: Image9,
    title: "Steem",
    desc: "Current work in progress for a school project, Steam clone using React, Node, Tailwind. Working on wishlist.",
